                ...
                <div class="card p-3 shadow-sm bg-light border-0">
                    ...
                    <form action="menu_dashboard.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="item_image" class="form-control" placeholder="ဥပမာ - [https://images.unsplash.com/](https://images.unsplash.com/)..." required>
                        ...
                        if ($result_food_items && $result_food_items->num_rows > 0) {
                            while ($item = $result_food_items->fetch_assoc()) {
                                ...
                                if (strpos($img_file, 'http') === 0) {
                                    ...
                                    $img_src = "[https://images.unsplash.com/photo-1546069901-ba9599a7e63c](https://images.unsplash.com/photo-1546069901-ba9599a7e63c)";
                                }
                        ?>
                            <tr>
